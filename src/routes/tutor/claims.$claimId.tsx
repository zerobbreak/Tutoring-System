      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div className="space-y-1">
          ...
          <p className="flex items-center gap-2 text-sm text-muted-foreground">
            ID:{" "}
            <span className="font-mono text-xs text-foreground/80">{claim.id}</span>
          </p>
        </div>
        {claim.status === "DRAFT" ? (
          <Button
        ...
        <div className="space-y-6 md:col-span-2">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Lecturer: {claim.module?.lecturer?.full_name || "Unassigned"}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="border-border/80 bg-card shadow-sm">
            <CardHeader className="flex flex-row items-start justify-between gap-4 border-b border-border/60 bg-muted/20">
              <div>
                <CardTitle className="flex items-center gap-2 text-base">
                  <FileText className="size-5 text-(--lagoon-deep)" aria-hidden />
                  Attendance evidence
                </CardTitle>
                <CardDescription>
          ...
          <CardContent className="flex-1 pt-6">
            {claim.history.length === 0 ? (
              <div className="flex h-48 flex-col items-center justify-center text-center text-sm text-muted-foreground">
                ...
                No workflow events yet. Submit the claim or wait for lecturer
                review to see steps here.
              </div>
            ) : (
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between gap-2">
                        <p className="text-sm font-semibold text-foreground">
                          {formatWorkflowActionLabel(action.action_type)}
                        </p>
