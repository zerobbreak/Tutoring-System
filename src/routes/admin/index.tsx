...
function AdminDashboard() {
  ...
  return (
    <div className="min-h-0 flex-1 overflow-y-auto bg-[#FDFDFF] p-6 md:p-8 lg:p-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-10 flex flex-col gap-4 md:mb-12 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="font-serif text-3xl font-bold text-[#0A1128] md:text-4xl">
          ...
          <div className="lg:col-span-2">
            <div className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      <tr key={i} className="hover:bg-gray-50">
                        <td className="px-6 py-4 font-medium text-[#0A1128]">
                          {row.name}
                        </td>
              ...
              <div className="border-t border-gray-100 p-4 text-center">
                <Button
                  variant="ghost"
                  className="text-sm text-[#0A1128] hover:bg-gray-50"
                >
                  View All Users
                </Button>
              </div>
          ...
          <div className="space-y-8">
            <div className="rounded-2xl bg-[#FF6F61] p-8 text-white shadow-lg">
              ...
              <p className="mt-2 text-sm text-white/80">
                Scheduled update for database optimization tonight at 2:00 AM
                UTC.
              </p>
